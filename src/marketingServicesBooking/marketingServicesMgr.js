...
var marketingservicesDA = require('./marketingServicesDA');
var BookingDetails = require('../model/booking-detail.model');


exports.marketingBooking = function (req, res) {
    try {
        ...
        BookingDetails.findOne({}).select().sort('-bookingOrderId').limit(1).exec(function (err, details) {
          if (err) {
            ...
            if( details == null) {
             ...
             marketingservicesDA.marketingBooking(req, res, date, bookingOrder);
            } 
            else {
