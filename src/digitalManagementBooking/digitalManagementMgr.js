...
var digitalManagementDA = require('./digitalManagementDA');
var BookingDetails = require('../model/booking-detail.model');

exports.digitalMgmtBooking = function (req, res) {
    try {
        ...
        BookingDetails.findOne({}).select().sort('-bookingOrderId').limit(1).exec(function (err, details) {
          if (err) {
            ...
            if( details == null) {
             ...
             digitalManagementDA.digitalMgmtBooking(req, res, date, bookingOrder);
            } 
            else {
